...
public class Chateau extends Entite{
    ...
    public final int NBRE_LIGNES = Constantes.HAUTEUR_CHATEAU/Constantes.DIMENSION_BRIQUE;
    public final int NBRE_COLONNES = Constantes.LARGEUR_CHATEAU/Constantes.DIMENSION_BRIQUE;

    //Tableau contenant les briques du chateau true pour une brique
    boolean tabChateau[][] = new boolean[NBRE_LIGNES][NBRE_COLONNES];

    public Chateau(int xPos) {
        super.xPos = xPos;// Abscisse du point le plus a gauche
        super.yPos = Constantes.Y_POS_CHATEAU; //Ordonné du sommet du chateau
